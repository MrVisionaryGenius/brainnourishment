...
const players = [
  ...
  },
  {
    ...
    totalHour: 7 + 7.5 + 10.5 + 9.25 + 8.50 + 7.45 + 7.45 + 4.5 + 6 + 6.25 + 4.5 + 7.5 + 6,
    avgHour: (7 + 7.5 + 10.5 + 9.25 + 8.50 + 7.45 + 7.45 + 4.5 + 6 + 6.25 + 4.5 + 7.5 + 6) / 13,
  },
  {
    squidNumber: 4,
  ...
  },
  {
    ...
    totalHour: 6 + 2 + 2.40 + 2 + 2 + 2.13 + 3.3 + 3.22 + 3.45 + 2.30 + 3.31 + 2.2 + 4.06,
    avgHour: (6 + 2 + 2.40 + 2 + 2 + 2.13 + 3.3 + 3.22 + 3.45 + 2.30 + 3.31 + 2.2 + 4.06) / 13,
  },
  {
    squidNumber: 10,
