...
const SocialProofSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`py-16 bg-gradient-to-r from-gray-900 to-black transition-all duration-700 ease-out ${
        sectionVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
      }`}
    >
      <div className="container mx-auto px-4 text-center">
        <h2
          className={`text-3xl font-bold mb-8 font-serif transition-all duration-700 ease-out delay-200 ${
            sectionVisible
