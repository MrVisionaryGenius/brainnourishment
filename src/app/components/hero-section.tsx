...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section
      ref={heroRef}
      className={`relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden transition-all duration-700 ease-out ${
    ...
    >
      ...
      <div className="container mx-auto px-4 pt-20 pb-16 relative z-10">
        ...
        <div className="text-center max-w-5xl mx-auto">
          <h1
            className={`text-5xl sm:text-6xl md:text-7xl font-black leading-tight mb-6 text-white font-serif transition-all duration-800 ease-out delay-300 ${
              heroVisible
          ...
          <div
            className={`text-2xl sm:text-3xl md:text-4xl font-bold text-red-400 mb-8 animate-bounce font-serif transition-all duration-700 ease-out delay-400 ${
              heroVisible
                ? "opacity-100 translate-y-0"
          ...
          <p
            className={`text-xl sm:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed transition-all duration-700 ease-out delay-500 ${
              heroVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-4"
            }`}
          >
            You're{" "}
            <span className="text-red-500 font-bold">{age} years old.</span> At
            3 hours daily screen time, you'll lose{" "}
