...
const OfferSection: React.FC<OfferSectionProps> = ({ onBuyClick }) => {
    ...
    return (
        <section
            ref={sectionRef}
            className={`py-20 bg-gradient-to-br from-gray-900 to-black transition-all duration-700 ease-out ${sectionVisible
        ...
        >
            <div className="container mx-auto px-4">
                <div
                    className={`text-center mb-16 transition-all duration-700 ease-out delay-200 ${sectionVisible
                            ? "opacity-100 translate-y-0"
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div
                        ref={featuresRef}
                        className={`space-y-6 transition-all duration-800 ease-out delay-300 ${featuresVisible
                    ...
                    <div
                        ref={pricingRef}
                        className={`relative transition-all duration-800 ease-out delay-400 ${pricingVisible
